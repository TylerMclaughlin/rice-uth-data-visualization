...
"i" refers to operations on rows and "j" refers to operations on columns. "by" means calculate "j" grouping by "by"
...
```{r,echo=FALSE}
my.error <- "Rbokeh plots cannot be rendered on github markdown.  To see this plot, please navigate to https://rtylermclaughlin.shinyapps.io/shinyMarkdown/"
my.error
``` 
...
It's good programming practice to frequently test that variables are equal before proceding while *assuming* they are equal.  
